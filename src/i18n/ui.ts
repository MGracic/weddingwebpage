...
export const ui: Record<Lang, Record<string, string>> = {
  hr: {
    ...
    "details.venue": "Mjesto će biti objavljeno uskoro",
    "details.ceremony": "Ceremonija",
    "details.reception": "Slavlje",
    ...
    "rsvp.guests": "Broj gostiju",
    "rsvp.guest-names": "Imena gostiju",
    "rsvp.guest-names.placeholder": "Imena dodatnih gostiju",
  ...
  en: {
    ...
    "details.venue": "Venue to be announced",
    ...
    "rsvp.guest-names": "Guest Names",
    "rsvp.guest-names.placeholder": "Names of additional guests",
